...
class GomypayClient {
  ...
  public getPaymentUrl(params: GomypayPaymentParams): string {
    ...
    if (params.Buyer_Name) searchParams.append("Buyer_Name", params.Buyer_Name);
    if (params.Buyer_Telm) searchParams.append("Buyer_Telm", params.Buyer_Telm);
  ...
  public async requestPayment(params: GomypayPaymentParams) {
    ...
    if (params.Buyer_Name) formData.append("Buyer_Name", params.Buyer_Name);
    if (params.Buyer_Telm) formData.append("Buyer_Telm", params.Buyer_Telm);
